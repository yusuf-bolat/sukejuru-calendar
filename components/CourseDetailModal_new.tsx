      ...
      <div className="bg-gray-700/50 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="text-gray-200">{(course.lecture_credits + course.exercise_credits) || 'Not specified'}</p>
          </div>
          <div>
      ...
      <div className="bg-gray-700/50 rounded-lg p-4">
        ...
        {course.total_evaluations > 0 ? (
          ...
          <p className="text-gray-400 text-center py-8">
            No evaluations yet. Be the first to evaluate this course!
          </p>
        )}
      </div>
    </div>
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <div className="bg-gray-800 rounded-2xl border border-gray-700 shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
          ...
          <div className="p-6 overflow-y-auto flex-1">
            {activeTab === 'overview' ? renderOverviewTab() : renderFeedbackTab()}
          </div>
        </div>
      </div>
    </div>
